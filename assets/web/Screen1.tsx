...
export default function Screen1() {
  ...
  return (
      <SafeAreaView style={styles.container}>
        <View style={{flexDirection:'row',backgroundColor:  '#1BA9FF', paddimg: 10,width:415,height:45,position:'fixed'}}>
        ...
        <ScrollView>
          <Image style={styles.itemImg2} source={require('../img/1.png')} />
          <View style={styles.View1}>
            <Image style={styles.itemImg3} source={require('../img/ca_nau_lau.png')}></Image>
          ...
          <View style={styles.View2}>
            <Image style={styles.itemImg3} source={require('../img/ga_bo_toi.png')}></Image>
          ...
          <View style={styles.View3}>
            <Image style={styles.itemImg3} source={require('../img/xa_can_cau.png')}></Image>
          ...
          <View style={styles.View4}>
            <Image style={styles.itemImg3} source={require('../img/do_choi_dang_mo_hinh.png')}></Image>
          ...
          <View style={styles.View5}>
            <Image style={styles.itemImg3} source={require('../img/lanh_dao_gian_don.png')}></Image>
            ...
            <View style={styles.View6}>
              <Image style={styles.itemImg3} source={require('../img/hieu_long_con_tre.png')}></Image>
          ...
          <View style={styles.View7}>
            <Image style={styles.itemImg3} source={require('../img/trump 1.png')}></Image>
        ...
        <View style={{flexDirection:'row',backgroundColor:  '#1BA9FF', paddimg: 10,width:415,height:65,position:'fixed',top:800}}>
